        ...
        <div class="modal-body">
           ...
           <div class="mb-3">
               <label for="nama_event" class="form-label">Nama</label>
                  ...
                  name="nama_event" value="">
                  {{-- {{ $eventList->nama_event }} --}}
           </div>
           <div class="mb-3">
              <label for="deskripsi_event" class="form-label">Deskripsi</label>
                  <textarea class="form-control" id="deskripsi_event" name="deskripsi_event" value=""></textarea>
                  {{-- {{ $eventList->deskripsi_event }} --}}
           </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                  ...
                  {{-- {{ $eventList->tanggal_mulai }} --}}
                 </div>
                <div class="mb-3">
                  <label for="tanggal_selesai" class="form-label">Tanggal Selesai</label>
                   <input type="date" class="form-control" id="tanggal_selesai"
                  name="tanggal_selesai" value="">
                  {{-- {{ $eventList->tanggal_selesai }} --}}
                </div>
            </div>
