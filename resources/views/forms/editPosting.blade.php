@foreach ($posting as $item)
    <div class="modal fade" id="posting_{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-3">
                ...
                <div class="modal-body p-0">
                    <!-- form -->
                    <form action="/posting/{{ $item->id }}" method="post" enctype="multipart/form-data"
