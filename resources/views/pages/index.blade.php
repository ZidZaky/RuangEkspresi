...
<div class="post rounded mb-3 p-3">
    <div class="input d-flex gap-3 align-item-center">
        ...
        <button type="button" class="btn text-secondary align-items-center d-flex justify-content-between" data-bs-toggle="modal" data-bs-target="#karya">What's new? <i class="fi fi-rr-grin-alt d-flex "></i></button>
    </div>
    <hr>
...
<div class="list-post bg-white rounded p-3 mb-3">
    <div class="profile d-flex gap-3 mb-3">
        ...
        <div class="text m-0 p-0 ">
            <h6 class="p-0 m-0">Kevin Aluminium</h6>
            <small class="text-secondary m-0 p-0">23 May 2024 23.06 pm</small>
        </div>
    </div>
    <div class="post-body">
        <p>Waduhhhh</p>
