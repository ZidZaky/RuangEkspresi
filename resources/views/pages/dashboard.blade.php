...
@section('content')
    ...
    <div class="post rounded-3 mb-3 p-3 border border-secondary border-opacity-25 bg-white w-auto">
        <div class="input d-flex gap-3 align-item-center">
            ...
            @endif
            <button type="button"
                class="btn text-secondary align-items-center d-flex justify-content-between py-2 px-3 flex-grow-1"
                data-bs-toggle="modal" data-bs-target="#karya">What's new? <i
                    class="fi fi-rr-grin-alt d-flex "></i></button>
        </div>
    ...
    @foreach ($karyas as $karya)
        ...
        <button type="button"
            class="post-item text-secondary bg-white gap-2 rounded-3 p-4 border border-secondary border-opacity-25 w-100 mb-3"
            data-bs-toggle="modal" data-bs-target="#detailKarya_{{ $karya->id_karya }}">
            ...
            <div class="post-footer d-flex p-0 m-0 align-items-center">
                ...
                <i type="button" class="fi fi-rr-beacon d-flex gap-2 align-items-center text-secondary"
                    data-bs-toggle="modal" data-bs-target="#komentar">{{ $komentar->count() }}</i>
            </div>
